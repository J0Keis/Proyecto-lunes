...
let editingStudent = null; // Variable para rastrear qué estudiante estamos editando
...
function deleteEstudiante(student, row) {
    ...
    if (index !== -1) {
        ...
        row.remove(); // Elimina la fila correspondiente en el DOM
        calculateAverage(); // Recalcula el promedio
    }
}
...
function calculateAverage() {
    ...
    // Recalcular el promedio con las notas actualizadas
...
function editarEstudiante(student, row) {
    // Guardamos el estudiante en la variable global para editar
    editingStudent = student;

    // Llenamos el formulario con los datos actuales del estudiante
